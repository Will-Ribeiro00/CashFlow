...
namespace WebApi.Test
{
    public class CustomWebApplicationFactory : WebApplicationFactory<Program>
    {
        ...
        private void StartDatabase(CashFlowDbContext context, IPasswordEncrypter passwordEncrypter, IAccessTokenGenerator accessTokenGenerator)
        {
            var userTeamMember = AddUserTeamMember(context, passwordEncrypter, accessTokenGenerator);
            ...
            var userAdmin = AddUserAdmin(context, passwordEncrypter, accessTokenGenerator);
            var expenseAdmin = AddExpenses(context, userAdmin, expenseId: 2, tagId: 2);
            Expense_Admin = new ExpenseIdentityManager(expenseAdmin);

            context.SaveChanges();
        }
        private User AddUserTeamMember(CashFlowDbContext context, IPasswordEncrypter passwordEncrypter, IAccessTokenGenerator accessTokenGenerator)
        {
        ...
        private User AddUserAdmin(CashFlowDbContext context, IPasswordEncrypter passwordEncrypter, IAccessTokenGenerator accessTokenGenerator)
        {
        ...
        private Expense AddExpenses(CashFlowDbContext context, User user, int expenseId, int tagId)
        {
