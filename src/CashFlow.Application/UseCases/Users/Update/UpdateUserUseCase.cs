...
namespace CashFlow.Application.UseCases.Users.Update
{
    public class UpdateUserUseCase : IUpdateUserUseCase
    {
        ...
        public UpdateUserUseCase(ILoggedUser loggedUser, IUserUpdateOnlyRepository updateRepository, IUserReadOnlyRepository readRepository, IUnitOfWork unitOfWork)
        {
